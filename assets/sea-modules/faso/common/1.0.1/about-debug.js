define("faso/common/1.0.1/about-debug", [ "./nav-debug", "./iscript-debug", "./han-debug", "han-debug" ], function(require) {
    //导航菜单
    require("./nav-debug");
    //han.js
    require("./han-debug");
...
define("faso/common/1.0.1/han-debug", [ "han-debug" ], function(require) {
    require("han-debug");
});
